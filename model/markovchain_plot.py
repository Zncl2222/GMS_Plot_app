...
class markov_chain:
    ...
    def Subplot4(self, ratio):
        ...
        for i, ax in enumerate(axes.flatten()):
            ...
            ax.plot(self.Z[count][x2,0], self.Z[count][x2,1],linewidth=2,color='r',linestyle='--')
            ax.set_ylim([0, 1])
    ...
    def Subplot2(self, ratio):
        ...
        for i, ax in enumerate(axes.flatten()):
            ...
            ax.plot(self.Z[count][x2,0]*ratio, self.Z[count][x2,1],linewidth=2,color='r',linestyle='--')
            ax.set_ylim([0, 1])
